...
export class initialMigration1581628531326 implements MigrationInterface {
    name = 'initialMigration1581628531326'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "role_permissions" ("id" SERIAL NOT NULL, "creatorUserId" integer, "creationTime" TIMESTAMP, "tenantId" integer, "permissionId" integer NOT NULL, "roleId" integer NOT NULL, "isGranted" boolean NOT NULL, "type" character varying NOT NULL, CONSTRAINT "PK_84059017c90bfcb701b8fa42297" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_c6f7d3ccdbcfcff2de15d95491" ON "role_permissions" ("type") `, undefined);
        await queryRunner.query(`CREATE TABLE "permissions" ("id" SERIAL NOT NULL, "creatorUserId" integer, "creationTime" TIMESTAMP, "name" character varying(200) NOT NULL, "isHost" boolean NOT NULL, "type" character varying NOT NULL, CONSTRAINT "PK_920331560282b8bd21bb02290df" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_f268ae606aacf1dc940820323c" ON "permissions" ("type") `, undefined);
        await queryRunner.query(`CREATE TABLE "user_permissions" ("id" SERIAL NOT NULL, "creatorUserId" integer, "creationTime" TIMESTAMP, "tenantId" integer, "permissionId" integer NOT NULL, "userId" integer NOT NULL, "isGranted" boolean NOT NULL, "type" character varying NOT NULL, CONSTRAINT "PK_01f4295968ba33d73926684264f" PRIMARY KEY ("id"))`, undefined);
