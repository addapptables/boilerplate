...
export class initialMigration1584717556984 implements MigrationInterface {
    name = 'initialMigration1584717556984'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "organization_unit_users" ("id" SERIAL NOT NULL, "creatorUserId" integer, "creationTime" TIMESTAMP, "userId" integer NOT NULL, "organizationUnitId" integer NOT NULL, CONSTRAINT "PK_0f2ca0de7edb1a69803b125ac39" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "organization_unit_roles" ("id" SERIAL NOT NULL, "creatorUserId" integer, "creationTime" TIMESTAMP, "roleId" integer NOT NULL, "organizationUnitId" integer NOT NULL, CONSTRAINT "PK_1eb1d6e529b4ecea86059540e74" PRIMARY KEY ("id"))`, undefined);
